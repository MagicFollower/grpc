package com.abc.springboot.grpc.service;


import com.abc.springboot.grpc.proto.HelloProto;
...
public final class HelloServiceGrpc {
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<HelloRequest> sayHelloAgain(
            io.grpc.stub.StreamObserver<HelloReply> responseObserver) {
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(getSayHelloAgainMethod(), responseObserver);
    }
  ...
  public static final class HelloServiceStub extends io.grpc.stub.AbstractAsyncStub<HelloServiceStub> {
    ...
    public io.grpc.stub.StreamObserver<HelloRequest> sayHelloAgain(
            io.grpc.stub.StreamObserver<HelloReply> responseObserver) {
      return io.grpc.stub.ClientCalls.asyncBidiStreamingCall(
              getChannel().newCall(getSayHelloAgainMethod(), getCallOptions()), responseObserver);
    }
  }
    ...
    public io.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        ...
        case METHODID_SAY_HELLO_AGAIN:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.sayHelloAgain(
                  (io.grpc.stub.StreamObserver<HelloReply>) responseObserver);
        default:
          throw new AssertionError();
      }
